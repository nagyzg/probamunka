    ...
    'panels' =>array (
        'LNK_NEW_CONTACT' => array (
            array (
                array (
                    'name' => 'last_name',
                    'customCode' => '{html_options name="Contactssalutation" options=$fields.salutation.options selected=$fields.salutation.value}&nbsp;<input name="Contactslast_name" size="25" maxlength="25" type="text" value="{$fields.last_name.value}">',
                ),
                'title',
            ), 
            array (
