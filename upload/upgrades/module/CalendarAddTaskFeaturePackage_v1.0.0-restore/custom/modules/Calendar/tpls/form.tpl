...
<div style="padding: 4px 0; font-size: 12px;">
	...
	{literal}
	<input type="radio" id="radio_task" value="Tasks" onclick="CAL.change_activity_type(this.value);" name="appttype" tabindex="101"/>
	{/literal}
	<label for="radio_task">{$MOD.LBL_CREATE_TASK}</label>											
</div>
